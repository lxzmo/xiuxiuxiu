...
import static  com.example.xiuxiuxiu.model.AuthResponseModel.failedListeningMsg;
...
import  com.example.xiuxiuxiu.utils.AppUtils;
...
/** XiuxiuxiuPlugin */
public class XiuxiuxiuPlugin implements FlutterPlugin, MethodCallHandler,ActivityAware {
   public static final String TAG = XiuxiuxiuPlugin.class.getSimpleName();
    ...
    public void onAttachedToEngine(@NonNull FlutterPluginBinding flutterPluginBinding) {
        MethodChannel methodChannel = new MethodChannel(flutterPluginBinding.getBinaryMessenger(), "xiuxiuxiu");
...
//            authClient.setEventSink(null);
//        }
//        Log.i(XiuxiuxiuPlugin.TAG, "取消监听" + authClient.getEventSink());
//    }
}
